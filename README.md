...
- 새로 연결한 MCP에는 `mindnprogress_refresh_ai_delegation`, `mindnprogress_retry_ai_delegation_report`가 추가됩니다. 기존 `mindnprogress_recover_ai_delegation`은 사용자 요청 후 기존 승인 범위의 실행 복구에 사용합니다.
