...
export type GroupWaitingDetail = { cardId: string; cardTitle: string; cardStatus: string; isRoot: boolean; item: { id: string; label: string; note?: string; resumeCondition?: string; since?: string }; fingerprint: string; review: { category: GroupWaitingCategory; impact: GroupWaitingImpact; valid: boolean; invalidReason?: string | null; reviewedAt: string; reviewedBy: { id: string; name: string } } | null }
...
export function filterGroupOverviewRows(rows: GroupOverviewRow[], query: string, filter?: string | boolean): GroupOverviewRow[]
